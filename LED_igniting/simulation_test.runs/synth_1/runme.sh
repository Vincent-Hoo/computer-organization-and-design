...
HD_PWD='C:/Users/Administrator/Desktop/simulation_test/simulation_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_igniting.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_igniting.tcl
