...
HD_PWD='C:/Users/Administrator/Desktop/player/player/player.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log player.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source player.tcl -notrace
