...
HD_PWD='E:/vivado_homework/MCPU/MCPU/MCPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCPU.tcl
